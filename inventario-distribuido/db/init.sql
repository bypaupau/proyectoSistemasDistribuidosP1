...
--  Estudiante 1 (columnas: id, nombre, descripcion, cantidad, precio, categoria).
...
--  (Pensados para que haya stock bajo, productos caros, varias categorias, etc.)
-- ----------------------------------------------------------------------------
INSERT INTO productos (nombre, descripcion, cantidad, precio, categoria) VALUES
  ('Teclado mecanico',  'Switches azules, retroiluminado',     12,  45.90, 'Perifericos'),
  ('Mouse inalambrico', 'Ergonomico, 1600 DPI',                 3,  19.99, 'Perifericos'),
  ('Monitor 24"',       'Full HD, 75Hz',                        8, 149.00, 'Monitores'),
  ('Laptop 14"',        'Core i5, 16GB RAM, 512GB SSD',         5, 820.00, 'Computadoras'),
  ('Audifonos',         'Over-ear con cancelacion de ruido',    2,  89.50, 'Audio'),
  ('Webcam 1080p',      'Con microfono integrado',              4,  35.00, 'Perifericos'),
  ('Disco SSD 1TB',     'NVMe M.2',                            20,  74.25, 'Almacenamiento'),
  ('Memoria RAM 8GB',   'DDR4 3200MHz',                         1,  28.75, 'Componentes'),
  ('Hub USB-C',         '7 puertos',                           15,  22.40, 'Accesorios'),
  ('Cargador 65W',      'GaN, USB-C',                           6,  31.00, 'Accesorios');
